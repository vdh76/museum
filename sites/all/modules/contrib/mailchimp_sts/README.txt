IMPORTANT: MailChimp will continue to support the STS service for the time being,
but all efforts are focused on the new Mandrill service and corresponding module.
The STS module is no longer bundled with the core MailChimp module and this
project is inteded solely for existing users to access the code. Any new users
interested in transaction email integration should look to the standalone
Mandrill project.
