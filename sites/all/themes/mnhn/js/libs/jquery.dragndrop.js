...
//(function(jQuery) {
    ...
    jQuery.fn.Drags = function(opts) {
        var ps = jQuery.extend({
            zIndex: 20,
            opacity: .7,
            handler: null,
            onMove: function() { },
        ...
        var dragndrop = {
            ...
            drop: function(e) {
                ...
                dragData.onDrop(e);
                jQuery().unbind('mousemove', dragndrop.drag)
        ...
        return this.each(function() {
            ...
            if (typeof ps.handler == 'undefined' || ps.handler == null)
                ...
                handler = (typeof ps.handler == 'string' ? jQuery(ps.handler, this) : ps.handle);
            handler.bind('mousedown', { e: me }, function(s) {
                var target = jQuery(s.data.e);
                var oldCss = {};
                ...
                jQuery().bind('mousemove', { dragData: dragData }, dragndrop.drag)
