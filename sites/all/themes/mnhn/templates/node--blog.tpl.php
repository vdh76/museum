  ...
  ?>
    ...
    <div class="post">
      ...
      <?php print $image ?>
        ...
        <a href="/<?php print $language->language ?>/<?php print drupal_get_path_alias('node/' . $node->nid) ?>"
           class="link_post">Lire l'article complet</a>
        <div class="comments">
            <p class="link_comment">
                <strong><?php print mnhn_blog_comment_nb($node->nid) ?></strong>
                -
                <a href="/<?php print $language->language ?>/<?php print drupal_get_path_alias('node/' . $node->nid) ?>#comment_anchor">Laisser
                    un commentaire</a></p>
    ...
    <div class="post">
      ...
      <?php print $image ?>
        ...
        <div class="comments">
            <p class="link_comment">
                <strong><?php print mnhn_blog_comment_nb($node->nid) ?></strong>
                - <a href="javascript:;" id="link_post_comment">Laisser un
                    commentaire</a></p>
        </div>
        ...
        <div class="comments">
            <p class="link_comment"><strong>Poster un nouveau
                    commentaire</strong></p>
        </div>

        <div class="post_comment_message">
            Votre commentaire a été ajouté à la file d'attente pour modération
            par l'administrateur du site et il sera publié après son
            approbation.
        </div>

        <a name="comment_anchor"></a>
        <div class="post_comment_form" id="comment"
             rel="blog_<?php print $node->nid; ?>">
            <ul>
                <li>
                ...
                <li>
                    <label for="adresse">Votre commentaire <span>*</span>
                        :</label>
            ...
            <div class="spam">
                ...
                <div class="g-recaptcha"
                     data-sitekey="6LcMllkUAAAAADxrtXIEt8dxTKFAJR-hsPMSpJ8E"></div>
            </div>
            <div class="clearfix"></div>
            <br/>
            <a href="javascript:;" class="link">Envoyer</a>
