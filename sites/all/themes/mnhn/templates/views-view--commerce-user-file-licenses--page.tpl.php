...
drupal_add_js('
			...
			jQuery(function() {
			    jQuery("ul.menu-vertical li:eq(2)").addClass("activ");
...
<h1><?php print t('Files')?></h1>
	<?php
	if(arg(1)==$user->uid){
		print l(t('Log out'), 'user/logout', array('attributes' => array('class' =>  array('logout'))));
	}else{ 
		$user_profile = user_load(arg(1));
		print '<h2>Fichiers du compte '.$user_profile->name.'</h2>';
}?>
	<br/><br/><br/>
<h2 class="greytitle"><?php print t('Digital files')?></h2>
