...
global $language;
?>
<a class="logo_header" href="/<?php print $language->language; ?>"><span>Muséum d\'histoire naturelle du Havre</span></a>
 <?php print $content; ?>
 <a class="logo_blog" href="#">
 <span>Le Blog du Muséum</span>
</a>