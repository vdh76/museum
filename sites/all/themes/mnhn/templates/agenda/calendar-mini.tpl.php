...
drupal_add_js(drupal_get_path('theme', 'muma') .'/js/mini-calendar.js', 'file');

?>
<div class="calendar-calendar bloc_muma" data-year="<?php print date('Y',strtotime($view->exposed_input['mini']));  ?>"><div class="month-view">
<?php if ($show_title): ?>
    ...
    <tr>
      <?php foreach ($day_names as $cell): ?>
        <th class="<?php print $cell['class']; ?>">
          <?php print strtoupper($cell['data']); ?>
        </th>
      <?php endforeach; ?>
    </tr>
  </thead>
...
</table><div class="content_mini_calendar"></div>
</div></div>